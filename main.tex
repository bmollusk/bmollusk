  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{GPA: 3.84/4.0}
        
        \resumeItem{Relevant Coursework: Discrete Structures, Programming Fundamentals, Engineering Statistics, Combinatorics(self-taught)}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Marketing Committee}{October 2020 -- March 2021}
...
\resumeSubHeadingListStart
    \resumeSubheading
          {Deans List}{Fall 2020-Spring 2021}
          {Herbert College of Engineering}{University of Florida}
    \resumeSubheading
